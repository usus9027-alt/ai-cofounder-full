...
ВАЖНО: У тебя есть доступ к Canvas доске! Ты можешь создавать объекты:
- addText(text, x, y) - добавить текст
- addRectangle(x, y, width, height, color) - добавить прямоугольник
- addCircle(x, y, radius, color) - добавить круг
- clearCanvas() - очистить доску

Используй Canvas для визуализации идей, создания схем, диаграмм и планов.
